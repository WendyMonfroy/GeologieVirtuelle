...
namespace Valve.VR.InteractionSystem
{
    ...
    //-------------------------------------------------------------------------
    public class HandModified : MonoBehaviour
    {
        /* ---------------------------------------------------------------
         * 
         * use this script content to overwrite the SteamVR Hand.cs script
         * 
         *         this wil allow grabbing terrain with two hands
         * 
         * --------------------------------------------------------------- */
        ...
        //-------------------------------------------------
        // variable d'interactions à deux mains 
        //-------------------------------------------------
        ...
        public void AttachObject(GameObject objectToAttach, GrabTypes grabbedWithType, AttachmentFlags flags = defaultAttachmentFlags, Transform attachmentOffset = null)
        {
            ...
            // bout de code pour l'interaction à deux mains
            ...
            // fin du bout de code pour l'interaction à deux mains
        ...
        public void DetachObject(GameObject objectToDetach, bool restoreOriginalParent = true)
        {
            ...
            if (index != -1)
            {
                ...
                // debut du bout de code pour l'interaction à deux mains
        ...
        protected virtual void Awake()
        {
            ...
            if (trackedObject == null)
            {
                ...
                // pour l'interaction à deux mains
        ...
        protected virtual void TwoHandGrabbingUpdate(SteamVR_Behaviour_Pose updatedPose, SteamVR_Input_Sources updatedSource)
        {
            ...
            if (attachedObject != null && twoHandGrab)
            {
                ...
                if (initialObjectScale.x < 0.05 || (initialObjectScale.x >= 0.05 && p < 1))
                {
